...
class Comentario(models.Model):
    vulnerabilidade = models.ForeignKey(Vulnerabilidade, on_delete=models.CASCADE, related_name='comentarios')
    autor = models.CharField(max_length=100, blank=True, default='Anónimo')
...
class SugestaoVulnerabilidade(models.Model):
    ...
    descricao = models.TextField()
    risco = models.CharField(max_length=1, choices=RISCO_CHOICES, blank=True)
